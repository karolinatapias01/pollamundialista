...
const Matches = ({ matches, currentUser, onMakePrediction, onSaveRound16Prediction, onSaveQuartersPrediction, onSaveQuartersPrediction: onSaveSemisPrediction, reactions, onAddReaction, onRemoveReaction, users, initialPhase }) => {
